  ...
  return (
    <section>
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20 border-b border-slate-200">
          {/* Items */}
          <div className="max-w-sm mx-auto grid gap-8 md:grid-cols-3 lg:gap-16 items-start md:max-w-none">
            ...
            >
              ...
              <footer className="text-sm text-slate-500 font-medium">
                <a
                  className="text-slate-700 hover:text-white transition duration-150 ease-in-out"
                  href="#0"
                >
                  Trustpilot
                </a>{" "}
                - <span className="text-purple-500">4.9/5</span>
              </footer>
            </article>
            {/* 2nd Testimonial */}
            <article
            ...
            >
              ...
              <footer className="text-sm text-slate-500 font-medium">
                ...
                - <span className="text-purple-500">4.7/5</span>
              </footer>
            </article>
            {/* 3rd Testimonial */}
            <article
